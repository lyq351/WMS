...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#all").click(function(){
			//将下面所有组件全部选中
			//$("[name=roleUuids]").attr("checked","checked");
			var flag = $(this).attr("checked");
			$("[name=roleUuids]").attr("checked",flag == "checked");
		});
  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td>
				      	<s:select name="em.gender" list="@com.jk.wms.auth.emp.vo.EmpModel@genderMap" cssStyle="width:190px"></s:select>
					  </td>
