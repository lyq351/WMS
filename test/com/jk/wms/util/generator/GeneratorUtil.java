package com.jk.wms.util.generator;
...
public class GeneratorUtil {
	...
	private void generatorAction() throws Exception {
		...
		bw.write("import com.jk.wms.util.base.BaseAction;");
		bw.newLine();
	...
	private void generatorEbo()  throws Exception {
		...
		bw.write("import com.jk.wms.util.base.BaseQueryModel;");
		bw.newLine();
	...
	private void generatorEbi()  throws Exception {
		...
		bw.write("import com.jk.wms.util.base.BaseEbi;");
		bw.newLine();
	...
	private void generatorImpl()  throws Exception {
		...
		bw.write("import com.jk.wms.util.base.BaseImpl;");
		bw.newLine();
	...
	private void generatorDao() throws Exception {
		...
		bw.write("import com.jk.wms.util.base.BaseDao;");
		bw.newLine();
